...
/**
 * Creates a new match with the specified team names
 * 
...
/**
 * Creates empty matches without teams
 * 
 * @param {number} n the number of empty matches to make
 * @return {Matches} an object with keys as match numbers and values of match events
 */
