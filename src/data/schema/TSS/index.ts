import { TSSSchedule, Rounds, TSSDatabase, Match, Matches } from '@/types/TSS'
import { emptyRounds } from './emptyRounds'
import { filledRounds } from './filledRounds'

function createMatch(A: string, B: string): Match {
  return { A, B, winner: 'U', scoreA: 0, scoreB: 0 }
}

const emptyMatch = createMatch('', '')

function createEmptyMatches(n: number): Matches {
