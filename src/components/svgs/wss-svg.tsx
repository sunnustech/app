...
export default function Svg(color: Color): string {
  return `
    ...
    >
      <g transform="matrix(1.75446,0,0,1.75446,-670.82,-854.179)">
        <g transform="matrix(113.995,0,0,113.995,386,545)">
          <path
            d="M0.667,-0.009L0.572,-0.009L0.556,0.089L0.354,0.089L0.37,-0.009L0.272,-0.009L0.256,0.089L0.054,0.089L0.07,-0.009L-0.03,-0.009L0.049,-0.509L0.246,-0.509L0.183,-0.111L0.281,-0.111L0.296,-0.209L0.398,-0.209L0.383,-0.111L0.481,-0.111L0.544,-0.509L0.746,-0.509L0.667,-0.009Z"
