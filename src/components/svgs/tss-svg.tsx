...
export default function Svg(color: Color): string {
  return `
    ...
    >
      <g transform="matrix(1.75446,0,0,1.75446,-683.62,-854.179)">
        <g transform="matrix(113.995,0,0,113.995,386,545)">
          <path
            d="M0.63,-0.409L0.435,-0.409L0.356,0.089L0.154,0.089L0.233,-0.409L0.033,-0.409L0.049,-0.509L0.646,-0.509L0.63,-0.409Z"
