  ...
  */
  ...
  const items: Record<Field, Item[]> = {
    station: [
      ...
      { label: 'Sotong Houze', value: 'Sotong Houze', key: 2 },
      { label: 'Snake and Ladders', value: 'Snake and Ladders', key: 3 },
      { label: 'GOLF', value: 'GOLF', key: 4 },
      { label: 'Nerf Battle', value: 'Nerf Battle', key: 5 },
    ],
    action: [
      { label: 'Start Timer', value: 'startTimer', key: 0 },
      { label: 'Pause Timer', value: 'pauseTimer', key: 1 },
      { label: 'Resume Timer', value: 'resumeTimer', key: 2 },
      { label: 'Stop Timer', value: 'stopTimer', key: 3 },
      { label: 'Complete Stage', value: 'completeStage', key: 4 },
    ],
    facil: [
