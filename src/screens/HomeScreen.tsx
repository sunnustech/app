...
type logoutScreenNavigationType = NativeStackNavigationProp<RootStackParamList, "Home">
...
function HomeScreen() {
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior="padding">
      <Text>You are logged in as {auth.currentUser ? auth.currentUser.email : "ERROR"}!</Text>
